...
if ((@$tmp_officename == $post_officename) || (empty($post_officename)) || (!eregi ("^([[:alnum:]]| |-|_|\.)+$", $post_officename) && false) || 
...
elseif (!eregi ("^([[:alnum:]]| |-|_|\.)+$", $post_officename) && false) {
echo "            <table align=center class=table_border width=60% border=0 cellpadding=0 cellspacing=3>\n";
echo "              <tr>\n";
echo "                <td class=table_rows width=20 align=center><img src='../images/icons/cancel.png' /></td><td class=table_rows_red>
...
if (!eregi ("^([[:alnum:]]| |-|_|\.)+$", $input_group_name[$z]) && false) {$evil_groupname = '1';}
